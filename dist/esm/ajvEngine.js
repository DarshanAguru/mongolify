...
import { getOrSetRuleTree, makeOverrideKey, getJsonSchemaCache, getAjvValidatorCache, } from './cacheRegistry.js';
/**
 ...
 */
export const buildAjvValidator = (schema, overrides = {}, options = {}) => {
 ...
 */
export const emitJsonSchema = (schema, overrides = {}, options = {}) => {
    // Stable cache key
    const overrideKey = makeOverrideKey({ ...overrides, ...options });
    if (!schema) {
        // ---------------------------------------------
