...
exports.compileRulesFromMongooseSchema = void 0;
/**
 ...
 */
const compileRulesFromMongooseSchema = (schema) => {
    ...
    schema.eachPath((path, schematype) => {
        ...
        if (type === 'array') {
            ...
            if (caster) {
                ...
                if (caster.schema) {
                    ...
                    rules.items.children = (0, exports.compileRulesFromMongooseSchema)(caster.schema).children;
                }
            }
        ...
        if (schematype.schema) {
            rules.type = 'object';
            rules.children = (0, exports.compileRulesFromMongooseSchema)(schematype.schema).children;
        }
...
exports.compileRulesFromMongooseSchema = compileRulesFromMongooseSchema;
