 ...
 */
const ruleTreeCache = new WeakMap<object, any>();
 ...
 */
const jsonSchemaCache = new WeakMap<object, Map<string, any>>();
 ...
 */
const ajvValidatorCache = new WeakMap<object, Map<string, Function>>();
 ...
 */
const NullSchemaJsonCache = new Map<string, any>();
 ...
 */
const NullSchemaValidatorCache = new Map<string, Function>();
 ...
 */
const EMPTY_RULE_TREE = { type: 'object', fields: {} } as const;
 ...
 */
export const getOrSetRuleTree = (
  schema: object | null | undefined,
  compileFn: (schema: any) => any
) => {
  if (!schema) {
 ...
 */
export const makeOverrideKey = (overrides: any = {}) => {
  const overrideData = {
 ...
 */
export const getJsonSchemaCache = (schema: object | null | undefined) => {
  if (!schema) {
 ...
 */
export const getAjvValidatorCache = (schema: object | null | undefined) => {
  if (!schema) {
    // In "no-schema" mode, fallback to global Map keyed by overrideKey.
